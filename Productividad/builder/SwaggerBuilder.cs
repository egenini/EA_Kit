...
namespace Productividad.builder
{
    class SwaggerBuilder
    {
        ...
        public string build(EA.Element swaggerClass)
        {
            ...
            System.Windows.Forms.MessageBox.Show("Se ha generado el swagger json");
        ...
        private void writeInfo(JsonWriter writer)
        {
            ...
            {
                eaUtils.elementUtils.addDefect(swaggerElement, "Alert.title", "Este dato es obligatorio");

            }
            if ( ! jsonUtils.writePorpertyIfNotNullOrEmpty(writer, "version", this.swagger.info.version))
            {
                eaUtils.elementUtils.addDefect(swaggerElement, "Alert.version", "Este dato es obligatorio");
            }
